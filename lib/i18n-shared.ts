...
const text = {
  zh: {
    ...
    weChatOrderSummaryTitle: "订单详情",
    weChatOrderSummaryHint: "添加卖家微信后，可直接复制以下内容粘贴发送。",
    weChatCopyOrder: "复制订单信息",
    weChatCopied: "已复制！",
    weChatOrderLine1: "你好 BLUE ISLET，我想咨询下单：",
    weChatOrderCakeLabel: "蛋糕：",
    weChatOrderSizeLabel: "尺寸（英寸）：",
    weChatOrderPriceLabel: "价格：S$",
    weChatOrderQuestion: "请问最快可取货日期是？",
  ...
  en: {
    ...
    weChatOrderSummaryTitle: "Order Summary",
    weChatOrderSummaryHint: "After adding the seller on WeChat, copy and paste the details below.",
    weChatCopyOrder: "Copy Order Details",
    weChatCopied: "Copied!",
    weChatOrderLine1: "Hello BLUE ISLET, I would like to place an order enquiry:",
    weChatOrderCakeLabel: "Cake: ",
    weChatOrderSizeLabel: "Size (inches): ",
    weChatOrderPriceLabel: "Price: S$",
    weChatOrderQuestion: "May I know the earliest available pickup date?",
