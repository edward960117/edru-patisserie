...
export const translations = {
  en: {
    ...
    priceFrom: "From S$",
    chooseCakeOptionTitle: "Choose Your Cake Size",
    chooseCakeOptionSubtitle: "Select a size option to continue to product details.",
    optionInches: "in",
    viewProductDetails: "View Product Details",
    optionPageBack: "Back to Menu",
    optionNotFound: "Cake not found",
    productDetailTitle: "Cake Details",
    selectedSize: "Selected Size",
    productDescriptionLabel: "Description",
    optionDescriptionLabel: "Option Notes",
    productDetailBackToOptions: "Back to Size Options",
    productNotFound: "Product option not found",
  ...
  zh: {
    ...
    priceFrom: "起价 S$",
    chooseCakeOptionTitle: "选择蛋糕尺寸",
    chooseCakeOptionSubtitle: "请选择一个尺寸选项以查看商品详情。",
    optionInches: "寸",
    viewProductDetails: "查看商品详情",
    optionPageBack: "返回菜单",
    optionNotFound: "未找到该蛋糕",
    productDetailTitle: "蛋糕详情",
    selectedSize: "已选尺寸",
    productDescriptionLabel: "商品描述",
    optionDescriptionLabel: "尺寸说明",
    productDetailBackToOptions: "返回尺寸选择",
    productNotFound: "未找到该商品选项",
