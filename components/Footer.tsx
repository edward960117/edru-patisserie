...
export default function Footer() {
  ...
  return (
    <footer className="mt-24 border-t border-[color:var(--gold)]/28 bg-[linear-gradient(180deg,rgba(248,242,232,0),rgba(235,221,200,0.45))]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 text-sm text-[color:var(--ink-soft)]">
        <p className="lux-kicker">EDRU Patisserie</p>
        <p className="heading-serif mt-1 text-2xl text-[color:var(--ink)]">Handcrafted Cakes and Desserts</p>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          <a
            ...
            rel="noreferrer"
            aria-label="WhatsApp"
            className="btn-lux-outline gap-2"
          >
